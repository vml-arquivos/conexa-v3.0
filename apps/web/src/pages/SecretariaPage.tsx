...
const MODULOS_SECRETARIA = [
  ...
  },
  {
    ...
    desc: 'Ficha completa com dados da criança, responsáveis, saúde e documentos.',
  ...
  },
  {
    ...
    desc: 'Movimentações administrativas com motivo, data, histórico e rastreabilidade.',
  ...
  {
    label: 'Atestados e Documentos',
    desc: 'Receber, conferir e acompanhar documentos de matrícula e atestados médicos.',
    path: '/app/secretaria/atestados',
    icon: <FileArchive className="h-5 w-5" />,
    accent: 'border-l-sky-500',
  },
  {
    label: 'Saúde e Ocorrências',
    desc: 'Crianças passando mal, acidentes, medicação, ligações aos pais e encaminhamentos.',
  ...
  },
  {
    ...
    desc: 'Registro de ligações, atendimentos, retornos e encaminhamentos administrativos.',
    path: '/app/atendimentos-pais',
    icon: <MessageCircle className="h-5 w-5" />,
    accent: 'border-l-teal-500',
  },
  {
    label: 'Transporte e Retirada',
    desc: 'Controle de transporte escolar, autorizados para retirada e contatos de emergência.',
    path: '/app/secretaria/transporte',
    icon: <UserCog className="h-5 w-5" />,
    accent: 'border-l-violet-500',
  },
  {
    label: 'Funcionários da Unidade',
    desc: 'Profissionais, contatos, documentação e apoio administrativo da unidade.',
  ...
  const fila = [
    {
      ...
      desc: 'Acompanhar com professor responsável para fechar a frequência.',
      path: '/app/secretaria/faltas',
